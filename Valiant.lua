...
local Prediction = .117 -- DO NOT ask for me for HELP for this shit I HATE when people do that. Figure it out on your own you have brain cells.

local Y_Axis_Aim_Height = -1

local Smoothness = 16.6 -- Don't go lower.
